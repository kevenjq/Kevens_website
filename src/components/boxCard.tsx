...
const BoxCard: React.FC<BoxCardProps> = ({
  ...
  return (
    <div className="flex flex-col justify-evenly overflow-hidden mx-5 my-10 lg:my-0 items-start shrink-0 rounded-md p-5 bg-amber-300 w-[90%] h-[300px] lg:w-[40%] lg:h-[400px] shadow-2xl snap-center ">
